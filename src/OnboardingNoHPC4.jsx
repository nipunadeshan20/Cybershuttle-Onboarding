...
import "../src/css/OnboardingStep3.css";
import OutlinedButton from "./components/OutlinedButton";
import OnboardingNoHPC4 from "./components/OnboardingNoHPC4";
...
export default function OnboardingNoHPC4Page() {
  return (
  ...
  <div className="signin-bottom">
    <div className="onboarding-footer2">
      <Link to="/OnboardingNoHPC3" className="btn-outline">Back</Link>
      <div className="footer-right">
        {/* <button className="btn-skip">Skip for now</button> */}
        <Link to="/OnboardingNoHPC2" className="btn-next">
