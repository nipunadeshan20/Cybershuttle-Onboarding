...
import OnboardingNoHPC from "./components/OnboardingNoHPC";
...
export default function OnboardingNoHPCPage() {
  return (
  ...
  <div className="signin-bottom">
    <div className="onboarding-footer2">
      <Link to="/OnboardingStep4" className="btn-outline">Back</Link>
